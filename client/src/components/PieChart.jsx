...
const PieChart = ({ threatAnalysisData = [], onClearHistory }) => {
  ...
  const colorPalette = [
    ...
    '#0ea5e9', '#3b82f6', '#6366f1', '#8b5cf6', '#a855f7', '#c084fc', '#e879f9', '#ec4899',
    '#f43f5e', '#fb7185', '#fda4af', '#fecaca', '#fed7aa', '#fef3c7', '#d9f99d', '#bbf7d0',
    '#a7f3d0', '#99f6e4', '#a5f3fc', '#bae6fd', '#ddd6fe', '#e9d5ff', '#f3e8ff', '#fce7f3',
    '#dc2626', '#ea580c', '#d97706', '#65a30d', '#16a34a', '#059669', '#0d9488', '#0891b2',
    '#0284c7', '#2563eb', '#4f46e5', '#7c3aed', '#9333ea', '#a21caf', '#be185d', '#e11d48',
    '#b91c1c', '#c2410c', '#b45309', '#4d7c0f', '#15803d', '#047857', '#0f766e', '#0e7490',
    '#0369a1', '#1d4ed8', '#4338ca', '#6d28d9', '#7e22ce', '#a21caf', '#be185d', '#e11d48'
  ];
  ...
  const createPieSlice = (startAngle, endAngle, innerRadius = 0, outerRadius = 100) => {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <input
              ...
              placeholder="Enter threat type (e.g., DDoS Attack, SQL Injection)"
              style={{
                flex: 1,
                padding: 'var(--space-3)',
                fontSize: '14px',
          ...
          <div style={{
            ...
            💡 Examples: DDoS Attack, SQL Injection, Port Scan, Malware, Phishing, Brute Force, Cross-Site Scripting, Man in the Middle, Buffer Overflow, BENIGN
          </div>
        </div>
        ...
        {threatData.length === 0 ? (
          ...
          <div style={{
            ...
            <p style={{ 
              ...
              Start analyzing log entries or manually add threat types above to see distribution patterns here.
            </p>
          </div>
        ) : (
          <>
              ...
              {dataWithPercentages.map((item, index) => (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: hoveredSlice === index ? '0 4px 12px rgba(0,0,0,0.3)' : 'none'
                  }}
            ...
            <div style={statsContainerStyle}>
              <div style={statItemStyle}>
                ...
                <p style={{ 
                  ...
                  {dataWithPercentages
                    .filter(item => !['BENIGN', 'Normal Traffic', 'normal_traffic', 'Legitimate', 'Safe'].some(benign => 
            ...
            <div style={{
              ...
              {(() => {
                const mostCommon = dataWithPercentages
                  ...
                  .reduce((max, item) => item.count > max.count ? item : max, { count: 0, type: 'None' });
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 'var(--space-2)' }}>
                    <div
                      style={{
                        width: '16px',
                        height: '16px',
                        backgroundColor: mostCommon.color || 'var(--color-text-muted)',
                        borderRadius: '50%'
                      }}
                    />
                    <p style={{ 
                      ...
                      {mostCommon.type} {mostCommon.count > 0 ? `(${mostCommon.count})` : ''}
                    </p>
                  </div>
                );
              })()}
